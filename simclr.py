...
class SimCLR(object):
    ...
    def train(self, train_loader):
        ...
        for epoch_counter in range(self.args.epochs):
            ...
            if epoch_counter >= 10:
                self.scheduler.step()
            logging.debug(f"Epoch: {epoch_counter}\tLoss: {loss}\tCross Entropy Loss: {loss_self_super}\tReconstruction Error: {loss_autoencoder}\tTop1 accuracy: {top1[0]}")
            print(f'Epoch: {epoch_counter}\tLoss: {loss}\tNTXtent Loss: {loss_self_super}\tRecon Error: {loss_autoencoder}\tAcc: {top1[0]}')
